...
exports.paymentOrder = async (req, res) => {
  ...
  const data = {
    ...
    success_url: `https://aronnok.vercel.app/api/payment/success/${tran_id}`,
    fail_url: `https://aronnok.vercel.app/api/payment/fail/${tran_id}`,
    cancel_url: 'https://aronnok.vercel.app/cancel',
    ipn_url: 'https://aronnok.vercel.app/ipn',
...
exports.paymentSell = async (req, res,next) => {
  ...
  const data = {
    ...
    currency: 'BDT',
    tran_id: tran_id, // use unique tran_id for each api call
    success_url: `https://aronnok.vercel.app/api/payment/success/sell/${tran_id}?pname=${req.body.pname}&pdescription=${req.body.pdescription}&pprice=${req.body.pprice}&pphoto=${req.body.pphoto}&reqId=${req.params.reqProductId}`,
    fail_url: `https://aronnok.vercel.app/api/payment/fail/${tran_id}`,
    cancel_url: 'https://aronnok.vercel.app/cancel',
    ipn_url: 'https://aronnok.vercel.app/ipn',
    shipping_method: 'Courier',
