...
const OneProduct = ({ mypath, productId, userId, whattype }) => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // response = await axios.get(`https://aronnok.vercel.app/api/comingsoon/product/${userId}/${productId}`);
  ...
  const addToCart = async () => {
    try {
      await axios.post(`https://aronnok.vercel.app/api/cart/add/${userId}/${productId}`, {});
    } catch (error) {
  ...
  const addToFavourites = async () => {
    try {
      await axios.post(`https://aronnok.vercel.app/api/favourites/create/${userId}`, { "plantId": productId });
    } catch (error) {
      console.error('Error adding', error);
    }
    updateTotalQuantity();
  ...
  const addToWishlist = async () => {
    try {
      await axios.post(`https://aronnok.vercel.app/api/wishlist/create/${userId}`, { "plantId": productId });
    } catch (error) {
      console.error('Error adding', error);
    }
    updateTotalQuantity();
