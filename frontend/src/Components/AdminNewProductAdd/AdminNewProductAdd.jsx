...
const AdminNewProductAdd = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // }
      await axios.post('https://aronnok.vercel.app/api/product/create/65a294c44865e9f4138c7281', formData, {
      headers: {
      'Content-Type': 'multipart/form-data',
      },
      });
        //   const response = await fetch("https://aronnok.vercel.app/api/product/create/65a294c44865e9f4138c7281", {
        //   method: "POST",
        //   body: formData,
    // });
      //   console.log("mor")
